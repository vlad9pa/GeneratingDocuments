...
public class PdfServiceImpl implements PdfService{
    ...
    @Override
    public void generatePdf(OutputStream out) throws DocumentException {
        ...
        Chunk chunk = new Chunk("SOME TEXT HERE", font);
    ...
    private void renderTable(Document document, java.util.List<Map<String, String>> data) throws DocumentException {
